...
import org.rabbit.config.ClientConf

object Snowflake {
  private val snowflakeConf = SnowflakeConf()
  private val idGenerator = new SnowflakeIdGenerator(snowflakeConf.worker_id().get) //, snowflake.datacenter_id().get)
...
//    println(id)
    ...
    println( t - 1546300800000L)
    println((t - 1546300800000L) << 12)

    println( 0 << 10)


    println(((t - 1546300800000L) << 12) | (0 << 10) | 0)
  }
}
